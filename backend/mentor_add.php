...
if(isset($_POST['submit']))
{
    ...
    $insert = mysqli_query($conn, "INSERT INTO mentor (name, position, description, image) 
        VALUES ('$name', '$position', '$description', '$image')");

    if($insert)
    {
        $_SESSION['success_msg'] = "Mentor Added Successfully!";
...
<head>
  <meta charset="utf-8" />
  <title>AdminLTE v4 | Add Mentor</title>
...
<div class="row">
<div class="col-sm-6">
<h3 class="mb-0">Add Mentor</h3>
</div>
<div class="col-sm-6 text-end">
<a href="mentor_list.php" class="btn btn-primary">Back</a>
</div>
</div>
</div>
</div>
